...
CONST_LOG_BACKUP_FILE_COUNT = 30
...
MARKET_TURNOVER_MAPPING = {CONST_SH_MARKET: CONST_SH_STOCK_TURNOVER, CONST_SZ_MARKET: CONST_SZ_STOCK_TURNOVER,
                           CONST_ZX_MARKET: CONST_ZX_STOCK_TURNOVER, CONST_CY_MARKET: CONST_CY_STOCK_TURNOVER}
TYPE_NAME_MAPPING = {CONST_STOCK_TYPE_1: u"一类", CONST_STOCK_TYPE_2: u"二类", CONST_STOCK_TYPE_3: u"三类",
